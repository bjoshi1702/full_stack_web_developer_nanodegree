...
# argument list(movie_title, movie_storyline, movie_poster_image,
#        movie_trailer_youtube_link)

# object1
dear_zindagi = media.Movie(
    "Dear Zindagi",
    "Kaira, a young girl, faces problems in her relationships. "
    "She meets Dr Jehangir, who helps her resolve her issues "
    "with her parents and get a new perspective on life, which"
    " leads to her following her passion and an improvement in her love life.",
    "http://www.bollywoodlife.com/wp-content/uploads/2016/10/dear-zindagi.jpg",
    "https://youtu.be/5DkO7ksXY8E")
# object2
holiday = media.Movie(
    "Holiday",
    "After a bomb destroys the bus on which he was riding, a military officer "
    "(Akshay Kumar) foregoes his vacation to hunt down a terrorist and the "
    "sleeper cells under his command.",
    "http://www.bollywoodlife.com/wp-content/uploads/2014/06/poster-3.jpg",
    "https://youtu.be/_34g6rCe0YY")
# object3
padmavat = media.Movie(
    "Padmavat",
    "Set in 1303 AD medieval India, Padmaavat is the story of honor, valor "
    "and obsession. Queen Padmavati is known for her exceptional "
    "beauty along with a strong sense of justice and is the wife"
    " of Maharawal Ratan Singh and pride of the Kingdom of "
...
# object5
badrinath_ki_dulhania = media.Movie(
...
baahubali2 = media.Movie(
    "Baahubali 2",
    "When Bhallaladeva conspires against his brother to become the king of "
    "Mahishmati, he has him killed by Katappa and imprisons his wife. Years "
    "later, his brother's son returns to avenge his father's death.",
...
movies = [dear_zindagi, holiday, padmavat, dil_to_pagal_hai,
          badrinath_ki_dulhania, baahubali2]
